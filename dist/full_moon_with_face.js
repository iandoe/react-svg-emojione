...
module.exports = function() {
  return React.createElement(
	...
	React.createElement(
		"g",
		{ fill: "#827717" },
		React.createElement("path", { d: "m37 39c-3.5 4.9-11.3 4.8-9.8-3.7.6-3.3 2.2-13 2.2-13s0 6.2 0 10.6c0 7.6 2.1 7.3 7.6 6.1" }),
		React.createElement("path", { d: "m42.8 43.9c-7 4.8-14.7 4.8-21.6 0-.8-.6-1.6.4-1 1.4 2.1 3.5 6.4 6.6 11.8 6.6s9.7-3.1 11.8-6.6c.6-1-.2-2-1-1.4" }),
		React.createElement("path", { d: "m38.4 24.7c3.7 7 11.2 7 14.9 0 .2-.4-.3-.5-.9-.9-3.7 2.9-9.8 2.7-13.1 0-.6.4-1.1.6-.9.9" }),
		React.createElement("path", { d: "m10.7 24.7c3.7 7 11.2 7 14.9 0 .2-.4-.3-.5-.9-.9-3.7 2.9-9.8 2.7-13.1 0-.6.4-1.1.6-.9.9" })
	)
);
};
